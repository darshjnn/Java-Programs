...
public class SingleLinkedListImplementation {
	...
	public SingleLinkedListImplementation copy() {
		SingleLinkedListImplementation clone = new SingleLinkedListImplementation();
		Node temp = this.head;
		while (temp != null) {
	...
	public static void main(String[] args) {
		...
		SingleLinkedListImplementation clone = list.copy();
		clone.printList();
		...
		SingleLinkedListImplementation list2 = new SingleLinkedListImplementation();
		list2.addStart(2);
		list2.addEnd(1);
		list2.addEnd(1);
		list2.addEnd(2);
		...
		SingleLinkedListImplementation list3 = new SingleLinkedListImplementation();
		list3.addStart(1);
		list3.addStart(2);
		list3.addStart(3);
		list3.addStart(4);
		...
		list.printList();
		SingleLinkedListImplementation ll = new SingleLinkedListImplementation();
